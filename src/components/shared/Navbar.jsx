          ...
          <div className="flex-1 space-y-2 overflow-y-auto">
            ...
            {user && (
              <>
                ...
                {/* Show role-specific links when role is loaded */}
                {!roleLoading &&
                  currentRoleLinks.length > 0 &&
                  currentRoleLinks
                    .filter((link) => !link.isDashboard)
                    .map((link, idx) => (
                      <NavLink
                        key={idx}
                        to={link.path}
          ...
          <div className="pt-4 border-t border-base-200 mt-auto">
            {!user ? (
              <div className="space-y-3">
                ...
                >
                  <button className="btn-gradient w-full text-white hover-lift">
                    Login
                  </button>
                </Link>
                <Link
                  ...
                  className="block w-full"
                >
                  <button className="btn btn-outline border-base-300 w-full hover-lift">
                    Join Now
                  </button>
                </Link>
              </div>
